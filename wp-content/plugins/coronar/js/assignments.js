...
jQuery(function($) {
     ...
     * Initialization.
     **/
    function mdp_coronar_assignment_ini() {
    ...
    jQuery( document ).ready( function () {
        ...
        jQuery( ':input' ).on( 'change', function() { mdp_coronar_unsaved = true; } );

        /** Show warning if form not saved. */
        window.addEventListener( 'beforeunload', ( event ) => {
            if ( mdp_coronar_unsaved ) {
        ...
        jQuery( '#submit' ).on( 'click', function( e ) {
            if ( php_editor ) {
                php_editor.codemirror.save(); // Save data from CodeEditor to textarea.
                mdp_saveSettings();
            }
        ...
        mdp_readSettings();
        mdp_coronar_assignment_ini();

        /** Initialize Code Editor. */
        let php_editor;
        if ( jQuery( '#mdp-php-field' ).length ) {
          php_editor = wp.codeEditor.initialize( 'mdp-php-field' );
        }
